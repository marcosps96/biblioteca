...
$livrosComEmprestimo = livroComEmprestimoAction($conn2);
    ...
    <?php foreach ($books as $row) : ?>
        <tr>
            ...
            <td>
                ...
                <?php
                $aux = false;
                foreach ($livrosComEmprestimo as $livro){
                    if($livro['id_livro'] == $row['id']){
                        $aux = true;
                        break;
                    }
                }
                ...
                if (!$aux) {
                    ...
                    echo '<button class="btn-vermelho">Este livro está emprestado ou possui registros de empréstimo e não pode ser deletado.</button>';
                }
                ?>
