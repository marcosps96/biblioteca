...
CREATE TABLE IF NOT EXISTS `biblioteca`.`editora` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_editora_UNIQUE` (`id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`livro` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_livro_UNIQUE` (`id` ASC) ,
  INDEX `fk_livro_editora1_idx` (`id_editora` ASC) ,
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`genero` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_genero_UNIQUE` (`id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`autor` (
  ...
  `nome` VARCHAR(55) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_autor_UNIQUE` (`id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`emprestimo` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_emprestimo_UNIQUE` (`id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`livro_has_autor` (
  ...
  INDEX `fk_livro_has_autor_autor1_idx` (`id_autor` ASC) ,
  INDEX `fk_livro_has_autor_livro_idx` (`id_livro` ASC) ,
...
CREATE TABLE IF NOT EXISTS `biblioteca`.`livro_has_genero` (
  ...
  INDEX `fk_livro_has_genero_genero1_idx` (`id_genero` ASC) ,
  INDEX `fk_livro_has_genero_livro1_idx` (`id_livro` ASC) ,
